                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card">
                            ...
                            <div class="content">
                                <div class="row">
                                  <div class="col-md-12">
                                      <label class="">ค้นหารหัสบ้าน</label>
                                       <form action="sel_point.php" method="get" target="my_iframe3">
                                            <div class="col-md-8">
                                                <input type="text" class="form-control" name="id_house"> 
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <button type="submit" class="btn btn-success btn-xs "><i class="pe-7s-search"></i></button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                                    ...
                                    <form action="add_map.php" method="get" target="my_iframe3">
                                        <div class="col-md-12">
                                            <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="content">
                                <div class="row">
                                     <iframe name="my_iframe3" src="add_map.php" style="width: 100%; height: 550px" frameborder="0" scrolling="no"></iframe>
                            </div>
                        </div>
                    </div>
                    </div>
