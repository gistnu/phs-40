...
$lyrForest = $_GET['lyrForest'];
$lyrBase = $_GET['lyrBase'];
$lyrTerain = $_GET['lyrTerain'];
$lyrImagery = $_GET['lyrImagery'];
$amphoe2 = $_GET['amphoe2'];
$tambon2 = $_GET['tambon2'];
    ...
    <div class="main-panel">
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse"> <a href="" class="btn btn-xs" onclick="goBack()" ><i class="pe-7s-angle-left-circle"> กลับ </i></a>
                </div>
            </div>
        </nav>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="content">
                                <div class="row">
                                        <div class="col-md-12">
                                              <iframe name="my_iframe" src="plkmaps/mapquery.php?province2=65&amphoe2=<?php echo $amphoe2;?>&tambon2=<?php echo $tambon2;?>&module=siteRegister&lyrAdmin=1<?php echo $lyrPlace,$lyrHealth,$lyrWater,$lyrClimate,$lyrLand,$lyrLandUse,$lyrSoil,$lyrDisaster,$lyrForest,$lyrBase,$lyrTerain,$lyrImagery; ?>" style="width: 100%; height: 650px" frameborder="0" scrolling="no" ></iframe>
                                        </div>
                            </div>
                        </div>
                    </div>
