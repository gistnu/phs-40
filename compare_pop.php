...
$prov2 = พิษณุโลก;
$amphoe_name2 = $_GET[amphoe2];
$tambol_name2 = $_GET[tambon2];
$year2 = $_GET[year2];
...
${demo.css}
 ...
 if ($tambol_name2 != '') {
     ...
     $result2 = pg_query($db,"select *  from age_0_5_tm where pro_name like '%$prov2%' and amp_name like '%$amphoe_name2' and  tam_name like '%$tambol_name2' and  year_pop =  $year2 ; "); 
    $chart_index2 = pg_fetch_array($result2);

 }elseif ($amphoe_name2 != '') {
     $result2 = pg_query($db,"select *  from age_0_5_ap where pro_name like '%$prov2%' and amp_name like '%$amphoe_name2' and  year_pop =  $year2   ; "); 
    $chart_index2 = pg_fetch_array($result2);
 }elseif ($prov2 != '') {
     $result2 = pg_query($db,"select *  from age_0_5_pv where pro_name like '%$prov2%'  and  year_pop =  $year2  ; "); 
    $chart_index2 = pg_fetch_array($result2);
 }else{
    $result2 = pg_query($db,"select *  from age_0_5_th where  year_pop =  $year2 ; "); 
    $chart_index2 = pg_fetch_array($result2);
 }
                ...
                <div class="col-md-12">
                    ...
                    <table class="table table-striped table-hover ">
                          ...
                          <tbody>
                            <tr>
                              <td>จำนวนประชากรทั้งหมด</td>
                              <td  style="text-align: center"><?php echo number_format($chart_index2[p_mf_total]); ?> คน</td>
                            </tr>
                            <tr>
                              <td>ประชากรเพศชายทั้งหมด</td>
                              <td  style="text-align: center"><?php echo number_format($chart_index2[p_m_total]); ?> คน</td>
                            </tr>
                            <tr>
                              <td>ประชากรเพศหญิงทั้งหมด</td>
                              <td  style="text-align: center"><?php echo number_format($chart_index2[p_f_total]); ?> คน</td>
                            </tr>
                            <tr>
                              <td>ร้อยละของประชากรที่อยู่ช่วงอายุ 0 - 4 ปี </td>
                              <td  style="text-align: center"><?php echo round($chart_index2[mf4] *100 / $chart_index2[p_mf_total],2)  ; ?> %</td>
                            </tr>
                            <tr>
                              <td>ร้อยละของประชากรที่อยู่ช่วงอายุ 5 - 44 ปี </td>
                              <td  style="text-align: center"><?php echo round( ($chart_index2[mf9] + $chart_index2[mf14] + $chart_index2[mf19] + $chart_index2[mf24] + $chart_index2[mf29] + $chart_index2[mf34]  + $chart_index2[mf39] + $chart_index2[mf44]) * 100 / $chart_index2[p_mf_total],2  ) ; ?> %</td>
                            </tr>
                            <tr>
                              <td>ร้อยละของประชากรที่อยู่ช่วงอายุ 45 เป็นต้นไป </td>
                              <td  style="text-align: center"><?php echo round( ($chart_index2[mf49] + $chart_index2[mf54] + $chart_index2[mf59] + $chart_index2[mf64] + $chart_index2[mf69] + $chart_index2[mf74]  + $chart_index2[mf79] + $chart_index2[mf84] + $chart_index2[mf89] + $chart_index2[mf94] + $chart_index2[mf99] + $chart_index2[mf100]) * 100 / $chart_index2[p_mf_total],2  ) ; ?> %</td>
                            </tr>
                            <tr>
                              <td>ร้อยละของประชากรที่อยู่ช่วงวัยเด็ก (อายุต่ำกว่า 15 ปี) </td>
                              <td  style="text-align: center"><?php echo round( ($chart_index2[mf4] + $chart_index2[mf9] + $chart_index2[mf14]) * 100 / $chart_index2[p_mf_total],2  ) ; ?> %</td>
                            </tr>
                            <tr>
                              <td>ร้อยละของประชากรที่อยู่ช่วงวัยแรงงาน (อายุ 15 - 59 ปี) </td>
                              <td  style="text-align: center"><?php echo round( ($chart_index2[mf19] + $chart_index2[mf24] + $chart_index2[mf29] + $chart_index2[mf34]  + $chart_index2[mf39] + $chart_index2[mf44] + $chart_index2[mf49] + $chart_index2[mf54] + $chart_index2[mf59]) * 100 / $chart_index2[p_mf_total],2  ) ; ?> %</td>
                            </tr>
                            <tr>
                              <td>ร้อยละของประชากรที่อยู่ช่วงวัยสูงอายุ (60 ปี ขึ้นไป) </td>
                              <td  style="text-align: center"><?php echo round( ($chart_index2[mf64] + $chart_index2[mf69] + $chart_index2[mf74]  + $chart_index2[mf79] + $chart_index2[mf84] + $chart_index2[mf89] + $chart_index2[mf94] + $chart_index2[mf99] + $chart_index2[mf100]) * 100 / $chart_index2[p_mf_total],2  ) ; ?> %</td>
                            </tr>
                            <tr>
                              <td>ดัชนีผู้สูงอายุ</td>
                              <td  style="text-align: center"><?php echo  round( (($chart_index2[mf64] + $chart_index2[mf69] + $chart_index2[mf74]  + $chart_index2[mf79] + $chart_index2[mf84] + $chart_index2[mf89] + $chart_index2[mf94] + $chart_index2[mf99] + $chart_index2[mf100]) * 100 / $chart_index2[p_mf_total]) /  (($chart_index2[mf4] + $chart_index2[mf9] + $chart_index2[mf14]) * 100 / $chart_index2[p_mf_total]) *100, 2)   ; ?> %</td>
                            </tr>
                          </tbody>
                        </table> 
...
$(document).ready(function () {
    Highcharts.chart('container2', {
        ...
        series: [{
            name: 'ชาย',
            data: [<?php echo -$chart_index2[m4],' , ',-$chart_index2[m9] ,' , ',-$chart_index2[m14],' , ',-$chart_index2[m19],' , ',-$chart_index2[m24],' , ',-$chart_index2[m29],' , ',-$chart_index2[m34],' , ',-$chart_index2[m39],' , ',-$chart_index2[m44],' , ',-$chart_index2[m49],' , ',-$chart_index2[m54],' , ',-$chart_index2[m59],' , ',-$chart_index2[m64],' , ',-$chart_index2[m69],' , ',-$chart_index2[m74],' , ',-$chart_index2[m79],' , ',-$chart_index2[m84],' , ',-$chart_index2[m89],' , ',-$chart_index2[m94],' , ',-$chart_index2[m99],' , ',-$chart_index2[m100]  ; ?>]
        }, {
            name: 'หญิง',
            data: [<?php echo $chart_index2[f4],' , ',$chart_index2[f9] ,' , ',$chart_index2[f14],' , ',$chart_index2[f19],' , ',$chart_index2[f24],' , ',$chart_index2[f29],' , ',$chart_index2[f34],' , ',$chart_index2[f39],' , ',$chart_index2[f44],' , ',$chart_index2[f49],' , ',$chart_index2[f54],' , ',$chart_index2[f59],' , ',$chart_index2[f64],' , ',$chart_index2[f69],' , ',$chart_index2[f74],' , ',$chart_index2[f79],' , ',$chart_index2[f84],' , ',$chart_index2[f89],' , ',$chart_index2[f94],' , ',$chart_index2[f99],' , ',$chart_index2[f100]  ; ?>]
        }]
    });
});
    </script>
...
// Database connection settings
    ...
    // Retrieve start point
    // Connect to database
     $sql = "select *,ST_AsGeoJSON(geom) AS geojson from age_0_5_tm a inner join pop_plk40sim b on a.tam_code = b.tam_code where b.tam_name like '%$tambol_name2' and  b.amp_name like '%$amphoe_name2' and b.pro_name = 'พิษณุโลก' and a.year_pop = $year2;";
...
var OpenStreetMap_BlackAndWhite = L.tileLayer('http://{s}.tiles.wmflabs.org/bw-mapnik/{z}/{x}/{y}.png', {
 ...
 <?php   
if ($tambol_name2 != '') {
     $result5 = pg_query($db,"select *  from tambon_centroids where tb_tn like '%$tambol_name2' and ap_tn like '%$amphoe_name2' and pv_tn = 'พิษณุโลก' ; "); 
    $dd = pg_fetch_array($result5);
    $lat = $dd[tb_lat]; 
    $longi = $dd[tb_lon]; 
    $zoom = 11;
     ...
     $result5 = pg_query($db,"select *  from amphoe_centroids where ap_tn like '%$amphoe_name2' and pv_tn = 'พิษณุโลก' ; "); 
    $dd = pg_fetch_array($result5);
    $lat = $dd[ap_lat]; 
    $longi = $dd[ap_lon]; 
    $zoom = 10;
...
OpenStreetMap_BlackAndWhite.addTo(map2);
map2.setView([<?php echo $lat ?>, <?php echo $longi ?>], <?php echo $zoom ?>);
        ...
        info2.update = function (props) {
            this._div.innerHTML = '<h3>แผนที่แสดงจำนวนประชากรปี <?php echo $year2; ?></h3>' +  (props ?
                '<b><center>ต. ' + props.prov_nam_t + '</b><br />' + props.value + ' คน'
                : '');
        };
        info2.addTo(map2);
